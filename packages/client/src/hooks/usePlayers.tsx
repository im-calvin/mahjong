  ...
  React.useEffect(() => {
    try {
      authenticatedContext.room.state.players.onAdd((player, _key) => {
        ...
        player.listen("avatarUri", (value) =>
          handlePropertyChange("avatarUri", value),
        );
        player.listen("name", (value) => handlePropertyChange("name", value));
        player.listen("sessionId", (value) =>
          handlePropertyChange("sessionId", value),
        );
        player.listen("talking", (value) =>
          handlePropertyChange("talking", value),
        );
        player.listen("userId", (value) =>
          handlePropertyChange("userId", value),
        );
      });
